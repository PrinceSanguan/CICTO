            ...
            >
                <div className="grid gap-6 lg:grid-cols-2 lg:items-start">
                    ...
                    <section className="rounded-2xl bg-white px-6 py-7 shadow-xl">
                        ...
                        {/*
                            The same honesty as the ticket page. This form goes
                            down the identical path, so it must not imply a
                            delivery the server cannot perform.
                        */}
                        {!support.mail_configured && (
                            ...
                            >
                                ...
                                A message sent here is recorded in the system
                                log rather than delivered — please use the phone
                                number opposite if it is urgent.
                            </p>
                        )}
                        ...
                        >
                            {({ processing, errors }) => (
                                <>
                                    {/*
                                        The endpoint is the ticket endpoint, so
                                        it expects an issue type. This shorter
                                        form does not ask for one; "Something
                                        else" is the honest constant rather than
                                        a guess at what the message is about.
                                    */}
                                    <input
                                        type="hidden"
                                        name="issue_type"
